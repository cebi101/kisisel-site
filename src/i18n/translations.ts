...
export const tr = {
  ...
  now: {
    ...
    items: [
      ...
      { k: "kabul edildim", v: "T3 Vakfı — FPV Drone Eğitimi" },
  ...
  about: {
    ...
    cvOzet:
      "İstanbul Arel Üniversitesi Yazılım Mühendisliği'nde tam burslu, bölüme birincilikle girmiş bir 3. sınıf öğrencisiyim. İlgimi çeken şey yapay zekânın teoride kaldığı yer değil, bir işe yaradığı yer: graf sinir ağlarıyla sağlık verisini modellemek, LLM tabanlı ajanlara gerçek bir görev yaptırmak, bir modelin neden o kararı verdiğini açıklayabilmek.",
  ...
  guestbook: {
    ...
    emptySub: "İlk yazan sen ol.",
    emptyCta: "Not bırak",
    errorTitle: "Notlar getirilemedi",
    errorSub: "Bağlantı ya da sunucu kaynaklı olabilir.",
    retry: "Tekrar dene",
  ...
  contact: {
    ...
    fMsg: "Mesajınız",
    fSend: "Gönder",
    fHint: "Mesajın doğrudan bana ulaşır. Ulaşmazsa şu adrese yazabilirsin:",
    ...
    errorInvalid: "Adın en az 2, mesajın en az 10 karakter olmalı ve e-postan geçerli olmalı.",
    social: "SOSYAL MEDYA",
  },
...
export const en: Dict = {
  ...
  now: {
    ...
    items: [
      ...
      { k: "accepted to", v: "T3 Foundation — FPV Drone Training" },
  ...
  about: {
    title: "About Me",
    year: "3rd Year",
    p1: "I'm a third-year Software Engineering student at Istanbul Arel University on a full scholarship, admitted ranked first. What draws me isn't AI in theory but AI where it does something: modelling health data with graph neural networks, giving LLM-based agents a real job to do, and being able to explain why a model decided what it decided.",
    cvOzet:
      "I'm a third-year Software Engineering student at Istanbul Arel University on a full scholarship, admitted ranked first. What draws me isn't AI in theory but AI where it does something: modelling health data with graph neural networks, giving LLM-based agents a real job to do, and being able to explain why a model decided what it decided.",
  ...
  guestbook: {
    ...
    emptySub: "Be the first to write one.",
    emptyCta: "Leave a note",
    errorTitle: "Couldn't load the notes",
    errorSub: "This may be a connection or server issue.",
    retry: "Try again",
  ...
  contact: {
    ...
    fMsg: "Your message",
    fSend: "Send",
    fHint: "Your message reaches me directly. If it doesn't, write to:",
    ...
    errorInvalid: "Name needs 2+ characters, message 10+, and a valid email address.",
    social: "SOCIAL MEDIA",
  },
